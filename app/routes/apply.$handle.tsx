import type {ActionFunctionArgs} from '@remix-run/server-runtime'; // or cloudflare/deno
import {json, defer, redirect} from '@remix-run/server-runtime'; // or cloudflare/deno
      ...
      <Form method="POST">
        <div className="space-y-12">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            Postulación para {data.product?.title}
            </h2>
