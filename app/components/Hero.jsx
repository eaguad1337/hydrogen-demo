    ...
    return (
        <div className="hero relative">
            <Slider {...settings} className="home-slider">
                <div className="slide">
                    <h2 className="title mb-10 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Lorem ipsum dolor sit<span className="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600"> accusamus eum</span></h2>
